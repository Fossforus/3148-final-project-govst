...
public class shoppingDriver{
    ...
    public static void main(String[] args){
        ...
        Product p2 = new Product(" Men's Cool Ultra-Soft Light Weight Crew-Neck T-Shirt" , "Keep cool and dry with our crew neck tee shirt, can be worn alone or as a layering piece
		adding depth to your wardrobe. Reach for this crew-neck T-shirt from 32 Degrees for an easygoing off-duty look. \n"  + 
