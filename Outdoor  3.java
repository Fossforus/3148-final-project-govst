...
public class shoppingDriver{
    ...
    public static void main(String[] args){
        ...
        Product p2 = new Product(" Trademark Tools 7-in-1 Plant Care Garden Tool Set" , " Make your green thumb grow with this 7-in-1 plant care garden tool set. \n"  + 
  14.99, 3," Trademark ","Outdoor");
