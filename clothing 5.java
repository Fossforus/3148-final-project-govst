...
public class shoppingDriver{
    ...
    public static void main(String[] args){
        ...
        Product p2 = new Product(" Men's Colorblocked Henley Pajama Shirt, Created for Macy's" , " Colorblocking updates the classic Henley in this Bar III pajama top, a stylish go-to for your laid-back look.\n"  + 
