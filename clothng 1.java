...
public class shoppingDriver{
    ...
    public static void main(String[] args){
        ...
        Product p2 = new Product(" Men's Lightweight Cotton Logo Pajama Pants" , "A modern take on loungewear,
		these jogger pants from Polo Ralph Lauren combine comfortable cotton jersey with a relaxed fit and an 
		allover signature pony print. \n"  + 
  24.99, 3," Ralph lauren  ","Clothing");
