...
public class shoppingDriver{
    ...
    public static void main(String[] args){
        ...
        Product p2 = new Product(" Master craft boat cover" , "Cover your MasterCraft X-15 or MariStar 215 with Zero Flex Flyer Wakeboard 
		Tower with this premium factory
		cover with this MasterCraft boat cover
		. This MasterCraft boat cover uses a ratchet strap system to gently hug just below the rubrail of your boat ensuring a perfect fit that is safe for storage on or off the trailer \n"  + 
  1494.99, 3," Mastercraft ","Outdoor");
